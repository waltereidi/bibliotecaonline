...
class PutLivrosRequestTest extends TestCase
{
    public $user;
    public $dados;
    public $url;
    public function SetUp(): void
    {
        ...
        $this->url = '/api/meuperfil/putLivros';
    }

    public function testePutRequest_SemToken_Retorna401(): void
    {
        //Setup
        $dados = [
    ...
    public function testePutRequestLivrosRetorna204(): void
    {
        //setup
        $dados = $this->dados;
        //execucao
        $request = $this->put($this->url, $dados);
        //assert
        $this->assertEquals($request->getStatusCode(), 204);
    }
    public function testePutRequestLivrosRetornaDadosIncorretos_naoespecificado_Retorna302(): void
    {
        //setup
        $dados =  $this->dados;
        unset($dados['id']);
    ...
    public function testePutRequestLivrosRetornaDadosIncorretos_limiteDeString_Retorn302(): void
    {
        //setup
        $dados = $this->dados;
    ...
    public function testePutRequestLivrosRetornaDadosIncorretos_urlIncorreta_Retorna302(): void
    {
        //setup
        $dados = $this->dados;
